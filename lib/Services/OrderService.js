...
const RetryPaymentRequest = require('../Requests/Orders/RetryPaymentRequest');
...
class OrderService extends ApiService {
     ...
     */
    retryPaymentRequest(orderReference) {
        this.verifyInput(this.constructor.name, { orderReference });

        return new RetryPaymentRequest(this.getRequestHandler(), orderReference);
    }
}
